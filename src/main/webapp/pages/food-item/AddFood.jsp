...
<nav class="flex justify-between items-center p-6 bg-gray-800">
    ...
    <div class="space-x-4">
        ...
        <a href="<%=request.getContextPath()%>/pages/admin/register.jsp" class="ml-4 px-4 py-2 bg-green-500 text-white rounded-md hover:bg-green-600">Signup</a>
        <a href="<%=request.getContextPath()%>/admin-logout" class="ml-4 px-4 py-2 bg-red-500 text-white rounded-md hover:bg-red-600">Logout</a>
    </div>
</nav>
